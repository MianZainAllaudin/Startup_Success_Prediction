...
with st.sidebar:
    ...
    if model_package:
        ...
        st.warning("Model file not found. Please train the model first (run the notebook).")
...
if predict_clicked:
    ...
    if model_package is None:
        ...
        if not insights:
            insights.append("Prediction is based on the combination of all entered features.")
